	...
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="学校类型" prop="xuexiaoleixing">
					<el-input v-model="ruleForm.xuexiaoleixing" placeholder="学校类型" clearable  :readonly="ro.xuexiaoleixing"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="学校类型" prop="xuexiaoleixing">
					<el-input v-model="ruleForm.xuexiaoleixing" placeholder="学校类型" readonly></el-input>
				</el-form-item>
...
export default {
    ...
    info(id) {
      this.$http({
        ...
        this.ruleForm.xuexiaojianjie = this.ruleForm.xuexiaojianjie.replace(reg,'../../../SchoolMap/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `xiaoyuanjianjie/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.xiaoyuanjianjieCrossAddOrUpdateFlag = false;
						 this.parent.search();
